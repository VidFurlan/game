...
Chest::Chest(std::string name, GameObject *parent, glm::vec3 position) : Entity(name, parent, new Polygon2D({{-2.0f, -2.0f}, {-2.0f, 2.0f}, {2.0f, 2.0f}, {2.0f, -2.0f}}), true, position, {1.0f, 1.0f}) {
    mMaxHealth = 2;
    mHealth = mMaxHealth;
    mImmunityTime = 0.3f;
