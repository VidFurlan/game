...
void DebugRenderer::drawLineGlobalPos(glm::vec2 p1, glm::vec2 p2, const glm::vec4& color) {
...
void DebugRenderer::drawLineAbsolutPos(const glm::vec2& p1, const glm::vec2& p2, const glm::vec4& color) {
